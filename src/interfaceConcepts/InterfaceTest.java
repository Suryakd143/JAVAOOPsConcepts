...
public class InterfaceTest implements InterfaceClass {
    ...
    public void abstractMethod() {
        System.out.println("This is abstractMethod of InterfaceTest Class");
    }

    /**
     * If all methods of an Abstract class are implemented with in the Abstract class then it is called "Concrete Class"
     */
    public static void concreteMethod() {
        System.out.println("This is concrete method. of InterfaceTest Class");
    }
}
...
class mainClass {
    public static void main(String[] args) {
        ...
        InterfaceClass it1;
        it1 = new InterfaceTest();  //(Object creation with reference to Interface Class. (known as "Up-Casting"))
        it1.abstractMethod();

        it1 = new InterfaceTest2();  //(Object creation with reference to Interface Class. (known as "Up-Casting"))
        it1.abstractMethod();
